# staging lives in production aws vpc
#environment = "staging"
ecs_clusters = {
  "Staging" = {
    ...
    lc_iam_instance_profile = "arn:aws:iam::629809936211:instance-profile/ecsInstance-Staging",
    asg_min_size            = 1,
  ...
  "Staging-nonui" = {
    ...
    lc_iam_instance_profile = "arn:aws:iam::629809936211:instance-profile/ecsInstance-Staging-nonui",
    asg_min_size            = 1,
    asg_desired_capacity    = 1,
    asg_max_size            = 2,
    lc_enable_monitoring    = true,
  ...
  "Staging-extra" = {
    ...
    lc_instance_type        = "t3.large",
    lc_key_name             = "devops-infrastructure",
    lc_iam_instance_profile = "arn:aws:iam::629809936211:instance-profile/ecsInstance-Staging-extra",
    asg_min_size            = 1,
    asg_desired_capacity    = 1,
    asg_max_size            = 2,
    lc_enable_monitoring    = true,
